(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('three'), require('gamepad-wrapper'), require('three/examples/jsm/webxr/VRButton.js'), require('three/examples/jsm/webxr/XRControllerModelFactory')) :
	typeof define === 'function' && define.amd ? define(['exports', 'three', 'gamepad-wrapper', 'three/examples/jsm/webxr/VRButton.js', 'three/examples/jsm/webxr/XRControllerModelFactory'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, (function () {
		var current = global.ELIXR;
		var exports = global.ELIXR = {};
		factory(exports, global.THREE, global.gamepadWrapper, global.VRButton_js, global.XRControllerModelFactory);
		exports.noConflict = function () { global.ELIXR = current; return exports; };
	})());
})(this, (function (exports, THREE, gamepadWrapper, VRButton_js, XRControllerModelFactory) { 'use strict';
  ...
  `;
	...
	class Core {
		constructor(sceneContainer, ecsyOptions = {}) {
			...
			document.body.appendChild(VRButton_js.VRButton.createButton(this._renderer));
