(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('three'), require('three/examples/jsm/webxr/ARButton'), require('three/examples/jsm/webxr/VRButton'), require('three/examples/jsm/webxr/XRControllerModelFactory')) :
	typeof define === 'function' && define.amd ? define(['exports', 'three', 'three/examples/jsm/webxr/ARButton', 'three/examples/jsm/webxr/VRButton', 'three/examples/jsm/webxr/XRControllerModelFactory'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, (function () {
		var current = global.ELIXR;
		var exports = global.ELIXR = {};
		factory(exports, global.THREE, global.ARButton, global.VRButton, global.XRControllerModelFactory);
		exports.noConflict = function () { global.ELIXR = current; return exports; };
	})());
})(this, (function (exports, THREE, ARButton, VRButton, XRControllerModelFactory) { 'use strict';
  ...
  `;
	...
	Object.defineProperty(standardMapping, "__esModule", { value: true });
	standardMapping.STANDARD_AXES_MAPPING = standardMapping.STANDARD_AXES = standardMapping.STANDARD_BUTTON_MAPPING = standardMapping.STANDARD_BUTTONS = void 0;
	standardMapping.STANDARD_BUTTONS = {
	    RC_BOTTOM: 'RC_BOTTOM',
	    RC_RIGHT: 'RC_RIGHT',
	    RC_LEFT: 'RC_LEFT',
	    RC_TOP: 'RC_TOP',
	...
	standardMapping.STANDARD_BUTTON_MAPPING = {
	    RC_BOTTOM: 0,
	    RC_RIGHT: 1,
	    RC_LEFT: 2,
	    RC_TOP: 3,
	...
	standardMapping.STANDARD_AXES_MAPPING = {
	    THUMBSTICK_LEFT_X: 0,
	    THUMBSTICK_LEFT_Y: 1,
	...
	var xrStandardMapping = {};

	Object.defineProperty(xrStandardMapping, "__esModule", { value: true });
	xrStandardMapping.XR_STANDARD_AXES_MAPPING = xrStandardMapping.XR_STANDARD_AXES = xrStandardMapping.XR_STANDARD_BUTTON_MAPPING = xrStandardMapping.XR_STANDARD_BUTTONS = void 0;
	xrStandardMapping.XR_STANDARD_BUTTONS = {
	    TRIGGER: 'TRIGGER',
	    SQUEEZE: 'SQUEEZE',
	    TOUCHPAD: 'TOUCHPAD',
	...
	xrStandardMapping.XR_STANDARD_BUTTON_MAPPING = {
	    TRIGGER: 0,
	    SQUEEZE: 1,
	    TOUCHPAD: 2,
	    THUMBSTICK: 3,
	...
	exports.AXES = lib.AXES = exports.BUTTONS = lib.BUTTONS = exports.GamepadWrapper = lib.GamepadWrapper = void 0;
	const standard_mapping_1 = standardMapping;
	const xr_standard_mapping_1 = xrStandardMapping;
	...
	exports.GamepadWrapper = lib.GamepadWrapper = GamepadWrapper;
	exports.BUTTONS = lib.BUTTONS = {
	    STANDARD: standard_mapping_1.STANDARD_BUTTONS,
	    XR_STANDARD: xr_standard_mapping_1.XR_STANDARD_BUTTONS,
	};
	exports.AXES = lib.AXES = {
	...
	class World extends EventTarget {
	  ...
	  fixedStep(dt, maxSubSteps) {
	    ...
	    const time = performance$1.now() / 1000; // seconds
	...
	var cannonEs = /*#__PURE__*/Object.freeze({
		__proto__: null,
		AABB: AABB,
		ArrayCollisionMatrix: ArrayCollisionMatrix,
		BODY_SLEEP_STATES: BODY_SLEEP_STATES,
	...
	class PhysicsComponent extends GameComponent {}
	...
	class RigidBodyComponent extends GameComponent {
		/**
		...
		setTransformFromObject3D(object3D) {
			this._positionUpdate = object3D.getWorldPosition(new THREE__namespace.Vector3());
		 ...
		 */
		get position() {
			return new THREE__namespace.Vector3().copy(this._body.position);
		}
		 ...
		 */
		get quaternion() {
			return new THREE__namespace.Quaternion().copy(this._body.quaternion);
		}
		 ...
		 */
		setVelocity(vec3) {
			this._velocityUpdate = new THREE__namespace.Vector3().copy(vec3);
		}
		...
		setAngularVelocity(vec3) {
			this._angularVelocityUpdate = new THREE__namespace.Vector3().copy(vec3);
		}
		 ...
		 */
		setPosition(vec3) {
			this._positionUpdate = new THREE__namespace.Vector3().copy(vec3);
		}
		 ...
		 */
		setQuaternion(quat) {
			this._quaternionUpdate = new THREE__namespace.Quaternion().copy(quat);
		}
	...
	THREE__namespace.Vector3.prototype.setFromQuaternion = function (quat) {
	...
	class RigidBodyPhysicsSystem extends GameSystem {
		init() {
		...
		_preStep(delta) {
			...
			this.queryGameObjects('rigidBodies').forEach((gameObject) => {
				...
				if (rigidBody._body.type == BODY_TYPES.KINEMATIC) {
					const deltaPosVec3 = gameObject
						.getWorldPosition(new THREE__namespace.Vector3())
						.sub(rigidBody.position);
					rigidBody._body.velocity.copy(deltaPosVec3.divideScalar(delta));
					const deltaQuat = gameObject
						.getWorldQuaternion(new THREE__namespace.Quaternion())
						.multiply(
							new THREE__namespace.Quaternion().copy(rigidBody.quaternion).conjugate(),
						);
					rigidBody._body.angularVelocity.copy(
						new THREE__namespace.Vector3().setFromQuaternion(deltaQuat).divideScalar(delta),
					);
				}
			});
		}
		...
		_postStep() {
			this.queryGameObjects('rigidBodies').forEach((gameObject) => {
				const rigidBody = gameObject.getMutableComponent(RigidBodyComponent);
				if (rigidBody.type != BODY_TYPES.DYNAMIC) return;
				switch (rigidBody.type) {
					case BODY_TYPES.DYNAMIC:
	...
	class Core {
		constructor(sceneContainer, ecsyOptions = {}) {
			this._ecsyWorld = new World$1(ecsyOptions);
			...
			this._vrButton = VRButton.VRButton.createButton(this._renderer);
			this._arButton = ARButton.ARButton.createButton(this._renderer);
			...
			this.game.addComponent(PhysicsComponent, {
				gravity: new THREE__namespace.Vector3(0, -9.8, 0),
			});
			...
			for (let i = 0; i < 2; i++) {
				...
				gripSpace.addEventListener('connected', (event) => {
					...
					this._controllers[handedness] = {
						targetRaySpace,
						gripSpace,
						gamepad: new exports.GamepadWrapper(event.data.gamepad),
