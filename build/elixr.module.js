...
var AXES = lib.AXES = BUTTONS = lib.BUTTONS = GamepadWrapper_1 = lib.GamepadWrapper = void 0;
...
var GamepadWrapper_1 = lib.GamepadWrapper = GamepadWrapper;
var BUTTONS = lib.BUTTONS = {
		...
		for (let i = 0; i < 2; i++) {
			...
			gripSpace.addEventListener('connected', (event) => {
				...
				this._controllers[handedness] = {
					targetRaySpace,
					gripSpace,
					gamepad: new GamepadWrapper_1(event.data.gamepad),
...
export { AXES, BUTTONS, Core, GameComponent, GameObject, GameSystem, GamepadWrapper_1 as GamepadWrapper, Not, cannonEs as Physics, PhysicsComponent, RigidBodyComponent, SingleUseGameSystem, SingleUseXRGameSystem, Types, XRGameSystem };
